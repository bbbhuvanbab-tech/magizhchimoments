    ...
    <section className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center max-w-6xl mx-auto">
        ...
        <div className="order-1 md:order-2 relative aspect-[3/4] overflow-hidden border border-border/40">
          <img src="https://mwklngfmvalxwjdomtxa.supabase.co/storage/v1/object/public/portfolio-images/Wedding/wedding4.JPG" alt="Signature floral installation" loading="lazy" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-background/20" />
        </div>
      </div>
    </section>
